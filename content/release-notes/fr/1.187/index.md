---
title: "Notes de version 1.187"
description: "Release notes v1.187 du 2026-07-23"
date: "2026-07-23"
version: "1.187"
---

# Notes de version 1.187 — 2026-07-23
...
- **Ce qui a été fait** : Implémentation d'une nouvelle vue par dossiers et par hashtags pour les documents de bateaux, création d'un composant de saisie de hashtags, ajout d'un bouton de prévisualisation et d'ouverture de documents dans un nouvel onglet, et ajustement de l'interface d'affichage pour les fichiers non étiquetés.
...
- **Ce qui a été fait** : Ajout de vérifications de valeurs nulles (`null-checks`) sur les tableaux de services complémentaires et report de l'initialisation des paramètres globaux lors du chargement du composant (`ngOnInit`).
...
- **Pourquoi** : Lors de l'attribution d'une tâche à un technicien, il était difficile de connaître l'équipe à laquelle il appartenait.
- **Ce qui a été fait** : Ajout du nom du groupe de travail (`workingGroup`) dans la liste de sélection des techniciens et dans leur affichage.

### Tri personnalisé dans la liste des leads du CRM
- **Pourquoi** : Les professionnels avaient besoin de classer la liste de leurs leads selon différents critères (ex. par date d'attribution ou rendez-vous à prendre) pour un suivi chronologique efficace.
- **Ce qui a été fait** : Implémentation d'options de tri multicritères dans la liste des leads du CRM pour optimiser l'organisation et le suivi commercial.
